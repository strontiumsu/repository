...
class clockAI_accel_exp(Scan1D, EnvExperiment):
    ...
    def measure(self, point):        
        ...
        # #mirror
        # self.pulse_N(2*self.N+1, (self.start_arm+self.N)%2, self.pi_times)
    ...
    def pulse_N(self, N, start_arm, times):        
        for i in range(int(N)):
            ...
            self.AI.pulse(times[int(arm_num)], self.arms[int(arm_num)]) #drive 3P0
            delay(150*ns)
